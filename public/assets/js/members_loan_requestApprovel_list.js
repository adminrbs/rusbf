...
function allmemberlonrequest() {
    $.ajax({
        type: 'GET',
        url: '/allmemberlonrequestapprovel',
            ...
            for (i = 0; i < response.data.length; i++) {
                ...
                for (var i = 0; i < dt.length; i++) {
                    ...
                    data.push({
                        ...
                        "action": '<button  title="Edit" class="btn btn-primary btn-sm" onclick="edit(' + dt[i].members_loan_request_id + ')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>&#160<button title="View" class="btn btn-success btn-sm"  onclick="view(' + dt[i].members_loan_request_id + ')"><i class="fa fa-eye" aria-hidden="true"></i></button>&#160<button title="Delete" class="btn btn-danger btn-sm" onclick="_delete(' + dt[i].members_loan_request_id + ')"><i class="fa fa-trash" aria-hidden="true"></i></button>&#160<button title="Approval" class="btn btn-info btn-sm" onclick="Approval(' + dt[i].members_loan_request_id + ')"><i class="fa fa-check-square-o" aria-hidden="true"></i></button>',
                    });
                }

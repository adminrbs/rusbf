            ...
            var data = [];
                for (i = 0; i < response.data.length; i++) {
                    ...
                    data.push({
                        ...
                        "thstatus":'<label class="form-check form-switch"><input type="checkbox"  class="form-check-input" name="switch_single" id="cbxUserRoleStatus" value="1"  onclick="cbxUserRoleStatus('+ stringId + ',this)" required '+isChecked+'></lable>',
                     });

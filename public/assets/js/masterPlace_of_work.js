            ...
            var data = [];
                for (i = 0; i < response.data.length; i++) {
                    ...
                    data.push({
                        ...
                        "thstatus":'<label title="Status" class="form-check form-switch"><input type="checkbox"  class="form-check-input" name="switch_single" id="cbxPlaceOfWorkStatus" value="1"  onclick="cbxPlaceOfWorkStatus('+ stringId + ',this)" required '+isChecked+'></lable>',
                     });

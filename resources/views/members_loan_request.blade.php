    ...
    <div class="card">
        ...
        <div class="card-body border-top">
            <div class="row mb-3">
                ...
                <div class="col-md-2">
                    <a href="/members_loan_form" id="btncontribution" class="btn btn-primary">
...
<script src="{{URL::asset('assets/js/vendor/notifications/bootbox.min.js')}}"></script>
<script src="{{URL::asset('assets/js/members_loan_request_list.js')}}?random=<?php echo uniqid(); ?>"></script>

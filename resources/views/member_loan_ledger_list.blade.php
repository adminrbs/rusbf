...
<div class="content">
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="mb-0">Member Loan Ledger List</h5>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="tbl_memeber_loan" class="table table-striped datatable-fixed-both-member-contribution" role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr>
                                        <th>Number</th>
                                        <th>Name</th>
...
<script src="{{URL::asset('assets/js/member_loan_ledger_list.js')}}?random=<?php echo uniqid(); ?>"></script>

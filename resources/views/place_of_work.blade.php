...
<div class="card">
    <div class="card-header d-flex align-items-center">
        <h5 class="mb-0">Place of Work</h5>
    ...
    <div class="card-body border-top">
        <div class="row mb-3">
            ...
            <div class="col-md-2">
                <button type="button" class="btn btn-primary" onclick="add_place_of_work();" style="float:right;"><i class="ph-plus"></i>&nbsp;Add New</button>
            </div>   
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="tbl_create_place_of_work" class="table table-striped "
            ...
            <div class="modal-body">
                <form action="" method="post" id="register_form" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="work_name" name="work_name" placeholder="Not Applicable"  required/>
                    </div>
...
<script src="{{URL::asset('assets/js/masterPlace_of_work.js')}}"></script>
@endsection
...
<div class="card">
    <div class="card-header d-flex align-items-center">
        <h5 class="mb-0">Place of Payroll Preparation</h5>
    ...
    <div class="card-body border-top">
        <div class="row mb-3">
            ...
            <div class="col-md-2">
                <button type="button" class="btn btn-primary" onclick="add_payroll();" style="float:right;"><i class="ph-plus"></i>&nbsp;Add New</button>
            </div>   
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="tbl_create_payroll" class="table table-striped "
            ...
            <div class="modal-body">
                <form action="" method="post" id="register_form" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="payroll_name" name="payroll_name" placeholder="Not Applicable"  required/>
                    </div>
...
<script src="{{URL::asset('assets/js/masterPlaceOfPayroll.js')}}"></script>
@endsection
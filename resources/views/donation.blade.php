...
<div class="card">
    ...
    <div class="card-body border-top">
        <div class="row mb-3">
            ...
            <div class="col-md-2">
                <button type="button" class="btn btn-primary" onclick="add_donetion();" style="float:right;"><i class="ph-plus"></i>&nbsp;Add New</button>
            </div>   
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="tbldonation" class="table table-striped "
                                role="grid" aria-describedby="example1_info">
                                <thead>
                                    <tr>
<th>Id</th>
                                        <th class="thname">Donation</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="post" id="register_form" class="needs-validation" novalidate>
                    ...
                    <div class="mb-3">
                        <label class="col-form-label">Donation<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="txtdonation" name="donation"  required/>
                    </div>
...
<script src="{{URL::asset('assets/js/donation.js')}}"></script>
@endsection